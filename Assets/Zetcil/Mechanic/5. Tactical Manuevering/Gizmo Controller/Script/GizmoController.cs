...
namespace Zetcil
{
    ...
    {
        public enum CMouseType { MouseDefault, MouseTransform }
        ...
        */
        ...
        void GetTarget()
        {
            if (selectedAxis == Axis.None && (Input.GetMouseButtonDown(IndexMouseButton) && MouseType == CMouseType.MouseTransform) )
            {
                RaycastHit hitInfo;
        ...
        public void ChangeMouseTransform()
        {
            ChangeMouseStatus(2);
        }
        ...
        public void ChangeMouseStatus(int aValue)
        {
            switch (aValue)
            {
                case 1:
                    ...
                    break;
                case 2:
                    MouseType = CMouseType.MouseTransform;
